...
<body style="background-image: url(../../assets/img/bg-reg.jpg); background-size: cover; background-repeat: no-repeat;">
	<div class="container">
		<div class="panel panel-primary" style="width: 580px; margin: 0px auto; margin-top: 50px; background-color: white; padding: 10px; border-radius: 5px;">
			<div class="panel-heading">
				<h2 class="text-center" style="margin-top: 20px;">ĐĂNG KÝ</h2>
			...
			<div class="panel-body">
				<form method="post" onsubmit="return validateForm();">
                    ...
                    <button class="btn btn-danger" style="margin-left: 230px;">Đăng Ký</button>
					<p>
						<a href="login.php" style="text-decoration: none; margin-left:200px">Tôi đã có tài khoản</a>
					</p>
